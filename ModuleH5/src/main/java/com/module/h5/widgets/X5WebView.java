...
import com.module.h5.inreractive.command.BaseCommond;
import com.module.h5.utils.H5Utils;
import com.module.h5.R;
import com.module.h5.inreractive.H5Interactive;
import com.module.h5.inreractive.IH5InvokeAndroid;
...
public class X5WebView extends WebView implements IH5InvokeAndroid {
    ...
    private H5ChromeClient chromeClient = new H5ChromeClient("jsAction", H5Interactive.class) {
        @Override
    ...
    @Override
    public void invoke(BaseCommond commond) {
        if (commond != null) {
            commond.execute();
        }
    }
